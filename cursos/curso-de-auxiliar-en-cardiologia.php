<?php
// Datos del curso
$curso_titulo = "CURSO DE AUXILIAR EN CARDIOLOGÍA";
$curso_descripcion = "Especialización en asistencia cardiológica y electrocardiografía. Diagnóstico y monitoreo de pacientes cardíacos. Aprende a realizar electrocardiogramas, interpretar resultados y asistir en procedimientos cardiológicos.";
$curso_duracion = "4 meses";
$curso_modalidad = "Online y Presencial";
$curso_sedes = "Morón, Laferrere, Lomas de Zamora, Avellaneda";
$curso_imagen = "../images/curso-auxiliar-cardiologia.jpg";
