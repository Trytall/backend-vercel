<?php
// Datos del curso
$curso_titulo = "CURSO DE COSMETOLOGÍA Y MAQUILLAJE";
$curso_descripcion = "Técnicas de maquillaje profesional y cosmetología. Tratamientos faciales y corporales. Formación para salones de belleza.";
