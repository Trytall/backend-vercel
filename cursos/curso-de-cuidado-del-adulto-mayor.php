<?php
// Datos del curso
$curso_titulo = "CURSO DE CUIDADO DEL ADULTO MAYOR";
$curso_descripcion = "Atención especializada para el cuidado de adultos mayores. Técnicas de asistencia y cuidados geriátricos. Desarrolla habilidades para trabajar en residencias, centros de día y atención domiciliaria.";
$curso_duracion = "5 meses";
$curso_modalidad = "Online y Presencial";
$curso_sedes = "Morón, Laferrere, Lomas de Zamora, Avellaneda";
$curso_imagen = "../images/curso-cuidado-adultos-mayores.jpg";
