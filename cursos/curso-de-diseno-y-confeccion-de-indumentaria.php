<?php
// Datos del curso
$curso_titulo = "CURSO DE DISEÑO Y CONFECCIÓN DE INDUMENTARIA";
$curso_descripcion = "Diseño de modas, patronaje y confección de prendas. Técnicas de costura y acabados profesionales. Formación para la industria textil.";
$curso_duracion = "8 meses";
$curso_modalidad = "Online y Presencial";
$curso_sedes = "Morón, Laferrere, Lomas de Zamora, Avellaneda";
$curso_imagen = "../images/curso-diseno-confeccion.jpg";
