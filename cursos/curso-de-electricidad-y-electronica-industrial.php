<?php
// Datos del curso
$curso_titulo = "CURSO DE ELECTRICIDAD Y ELECTRÓNICA INDUSTRIAL";
$curso_descripcion = "Automatización industrial y control de procesos. PLC y sistemas de control. Formación para la industria 4.0.";
