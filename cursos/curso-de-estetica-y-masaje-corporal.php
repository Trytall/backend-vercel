<?php
// Datos del curso
$curso_titulo = "CURSO DE ESTÉTICA Y MASAJE CORPORAL";
$curso_descripcion = "Técnicas de masaje terapéutico y estético. Tratamientos faciales y corporales. Formación para spas y centros de estética.";
$curso_duracion = "6 meses";
$curso_modalidad = "Online y Presencial";
$curso_sedes = "Morón, Laferrere, Lomas de Zamora, Avellaneda";
$curso_imagen = "../images/curso-estetica-masaje.jpg";
