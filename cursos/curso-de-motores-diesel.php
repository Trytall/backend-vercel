<?php
// Datos del curso
$curso_titulo = "CURSO DE MOTORES DIÉSEL";
$curso_descripcion = "Reparación y mantenimiento de motores diésel. Sistemas de inyección y turbo. Especialización en maquinaria pesada y vehículos comerciales.";
$curso_duracion = "6 meses";
$curso_modalidad = "Online y Presencial";
$curso_sedes = "Morón, Laferrere, Lomas de Zamora, Avellaneda";
$curso_imagen = "../images/curso-motores-diesel.jpg";
