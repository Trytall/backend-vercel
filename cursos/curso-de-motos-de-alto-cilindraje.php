<?php
// Datos del curso
$curso_titulo = "CURSO DE MOTOS DE ALTO CILINDRAJE";
$curso_descripcion = "Especialización en motos de alto rendimiento. Diagnóstico avanzado y tuning. Formación para talleres especializados en motos deportivas.";
$curso_duracion = "4 meses";
$curso_modalidad = "Online y Presencial";
$curso_sedes = "Morón, Laferrere, Lomas de Zamora, Avellaneda";
$curso_imagen = "../images/curso-motos-alta-cilindrada.jpg";
