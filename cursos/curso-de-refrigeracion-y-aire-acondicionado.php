<?php
// Datos del curso
$curso_titulo = "CURSO DE REFRIGERACIÓN Y AIRE ACONDICIONADO";
$curso_descripcion = "Mantenimiento y reparación de sistemas de refrigeración doméstica y comercial. Instalación de equipos de aire acondicionado. Aprende técnicas profesionales para trabajar en el sector HVAC.";
$curso_duracion = "6 meses";
$curso_modalidad = "Online y Presencial";
$curso_sedes = "Morón, Laferrere, Lomas de Zamora, Avellaneda";
$curso_imagen = "../images/curso-refrigeracion-aire.jpg";
